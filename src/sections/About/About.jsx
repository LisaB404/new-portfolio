  ...
  return (
    <div className="about-container">
      <div className="about-presentation">
        ...
        <p className="about-text">
          I earned a Master in Full Stack Development from Start2Impact, where I
          dove deep into HTML, CSS, JavaScript, React, and Node.js—and yes, I
          even enjoyed it. I love transforming ideas into clean, interactive,
          and user-friendly applications.
        </p>
        <p className="about-text">
          Before tech stole my heart, I studied languages and tourism economics,
          then worked in back-office roles where I mastered the noble arts of
          staying organized, solving problems, and emailing like a pro. These
          skills still come in handy—especially when wrangling stubborn bugs or
          tight deadlines.
        </p>
        <p className="about-text">
